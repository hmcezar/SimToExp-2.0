...
struct qt_meta_stringdata_ExpData_t {
    QByteArrayData data[4];
    char stringdata0[48];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ExpData_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ExpData_t qt_meta_stringdata_ExpData = {
    {
QT_MOC_LITERAL(0, 0, 7), // "ExpData"
QT_MOC_LITERAL(1, 8, 20), // "scalingFactorChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 17) // "chiSquaredChanged"

    },
    "ExpData\0scalingFactorChanged\0\0"
    "chiSquaredChanged"
};
...
void ExpData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ExpData *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ExpData::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ExpData::scalingFactorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ExpData::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ExpData::chiSquaredChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ExpData::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ExpData.data,
    qt_meta_data_ExpData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ExpData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExpData.stringdata0))
